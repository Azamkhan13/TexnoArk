        ...
        <div className="flex bg-white pt-[60px] px-[80px] rounded-xl h-[400px] justify-between max-sm:flex-col">
          ...
          <div>
            ...
            <ul className="mt-[20px]">
              <li
                onClick={() => Cookies.set("aboutus", "Texnoark haqida")}
                className="text-[14px] font-medium text-[#240E0099] mb-[16px] hover:text-[black] cursor-pointer"
              >
                <Link href={"/about"}>Texnoark haqida</Link>
              </li>
              <li
                onClick={() => Cookies.set("aboutus", "Muddatli to’lov")}
                className="text-[14px] font-medium text-[#240E0099] mb-[16px] hover:text-[black] cursor-pointer"
              >
                <Link href={"/about"}>Muddatli to’lov</Link>
              </li>
              <li
                onClick={() => Cookies.set("aboutus", "Yordam")}
                className="text-[14px] font-medium text-[#240E0099] mb-[16px] hover:text-[black] cursor-pointer"
              >
                <Link href={"/about"}>Yordam</Link>
              </li>
              <li
                onClick={() => Cookies.set("aboutus", "Tovarlarga kafolat")}
                className="text-[14px] font-medium text-[#240E0099] mb-[16px] hover:text-[black] cursor-pointer"
              >
                <Link href={"/about"}>Tovarlarga kafolat</Link>
              </li>
              <li
                onClick={() => Cookies.set("aboutus", "To‘lov usullari")}
                className="text-[14px] font-medium text-[#240E0099] mb-[16px] hover:text-[black] cursor-pointer"
              >
                <Link href={"/about"}>To‘lov usullari</Link>
              </li>
            </ul>
          </div>
          <div>
          ...
          <div className="w-[290px]">
            ...
            <p className="text-[#240E0099] font-medium mt-[20px]">
              ...
              O‘zbekiston Respublikasi, Toshkent shahri, Bodomzor yo‘li 1-tor
              ko‘chasi, 72
            </p>
            <p className="text-[#240E0099] font-medium mt-[16px] mb-[20px]">
              <span className="text-[black]">Telfonraqam :</span> +998 71 300 30
              30
            </p>
            <p className="text-[#240E0099] font-medium">
              <span className="text-[black]">Elktronpochta :</span>{" "}
              texnoarko@gmail.com
            </p>
          </div>
        </div>
