...
function Index() {
  const [slide1, setSlide1] = useState(1000000);
  const [slide2, setSlide2] = useState(51000000);
  ...
  return (
    <div>
      ...
      <Container>
        <button
          onClick={showDrawer}
          className="w-[90%] mx-auto hidden bg-white mt-[40px] py-[10px] font-medium rounded-md max-md:block "
        >
          Filter
        </button>
      </Container>
